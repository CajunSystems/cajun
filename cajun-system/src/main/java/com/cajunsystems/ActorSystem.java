...
import com.cajunsystems.mailbox.config.MailboxConfig;
...
public class ActorSystem {
    ...
    /**
     * Routes a message to the actor with the specified ID using the given delivery guarantee.
     * Local actor systems always deliver in-process, so the guarantee is ignored here;
     * cluster-aware systems override this to honor it for remote delivery.
     *
     * @param <Message> The type of the message
     * @param actorId The ID of the actor to route the message to
     * @param message The message to route
    ...
    /**
     * Routes a message to the actor with the specified ID after a delay, using the given
     * delivery guarantee. Local actor systems ignore the guarantee; cluster-aware systems
     * override this to honor it for remote delivery.
     *
     * @param <Message> The type of the message
     * @param actorId The ID of the actor to route the message to
     * @param message The message to route
    ...
    public <Message> void routeMessage(String actorId, Message message, Long delay, TimeUnit timeUnit,
        ...
        routeMessage(actorId, message, delay, timeUnit);
    }
